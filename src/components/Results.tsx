...
const Results = () => {
  ...
  return <section id="resultados" className="py-20">
      <div className="container mx-auto px-6">
        ...
        {/* Hero Image */}
        <div className="mb-16">
          <img src={successImage} alt="Equipe celebrando resultados e conquistas empresariais" className="w-full h-96 object-cover rounded-2xl shadow-card" />
        </div>

        {/* Stats Grid */}
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {stats.map((stat, index) => <Card key={index} className="p-8 text-center bg-gradient-card shadow-card hover:shadow-accent transition-smooth">
        ...
        <div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => <Card key={index} className="p-8 bg-gradient-card shadow-card hover:shadow-accent transition-smooth">
                {/* Stars */}
